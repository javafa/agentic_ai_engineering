...
class State(TypedDict):
    ...
    resolved: Annotated[list, add]   # ["tech", "billing"] 누적
...
# 5) 에이전트들 — 각자 system prompt와 허용 행선지만 다름
...
if __name__ == "__main__":
    ...
    print("=== 실행 추적 ===")
    for i, (agent, answer) in enumerate(result["trace"], 1):
        print(f"{i}. [{agent}] {answer[:200]}")